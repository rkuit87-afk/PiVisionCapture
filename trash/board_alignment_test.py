...
Usage:
  python board_alignment_test.py \
    --cam-left "rtsp://root:pass@192.168.3.146/live1s1.sdp" \
    --cam-right "rtsp://root:pass@192.168.3.145/live1s1.sdp"
...
def main():
    ...
    parser.add_argument(
        "--cam-left",
        default=os.environ.get("CAM_LEFT_RTSP_URL", "rtsp://root:pass@192.168.3.146/live1s1.sdp"),
        help="LEFT camera RTSP URL (env: CAM_LEFT_RTSP_URL)",
    )
    parser.add_argument(
        "--cam-right",
        default=os.environ.get("CAM_RIGHT_RTSP_URL", "rtsp://root:pass@192.168.3.145/live1s1.sdp"),
